...
public class bazarlistPanel extends JPanel {
	...
	bazarlistPanel(){
	    ...
	    try {
		    ...
		    setLayout(bdl);
		    JLabel picLabel = imageLabel.getImageLabel("picture//bazarlist.png");
		    ...
		    JButton view = new JButton("Bazar Lists");
		    ...
		    final Choice memberChoice = new Choice();
		    ArrayList<String>members = memberCheck.getMembers();
		    for(int i=0;i<members.size();i++){
		    	memberChoice.add(members.get(i));
		    }
		    memberChoice.add("other");
		    ...
		    confirm.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e)
	            {
	                	if(bazarCheck.performBazarInsertion(memberChoice,dateChoice,amountTf)){
	                		welcome k = welcome.ex;
			            	k.remove(welcome.body);
			            	welcome.body = new menuWindow();
			            	k.add(welcome.body);
		    ...
		    view.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e)
	            {
	            		...
	            		welcome k = welcome.ex;
		            	k.remove(welcome.body);
		            	welcome.body = new viewBazarlistPanel();
		            	k.add(welcome.body);
		            	k.refresh();
	            }
	        });     
