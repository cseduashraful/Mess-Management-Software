...
import stermip.mess.functions.depositCheck;
...
public class depositPanel extends JPanel {
	...
	depositPanel(){
	    ...
	    try {
		    ...
		    setLayout(bdl);
		    JLabel picLabel = imageLabel.getImageLabel("picture//deposit.png");
		    ...
		    JButton view = new JButton("Previous Deposits");
		    ...
		    confirm.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e)
	            {
	                	if(depositCheck.performDeposit(memberChoice,dateChoice,amountTf)){
	                		welcome k = welcome.ex;
			            	k.remove(welcome.body);
			            	welcome.body = new menuWindow();
			            	k.add(welcome.body);
