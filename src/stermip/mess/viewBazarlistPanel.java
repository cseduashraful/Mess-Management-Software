...
public class viewBazarlistPanel extends JPanel {
	Image bgimage = null;
	viewBazarlistPanel(){
	    ...
	    try {
		    ...
		    JLabel picLabel = imageLabel.getImageLabel("picture//bazarRecords.png");
		    ...
		    this.add(north, BorderLayout.NORTH);
		    	...
		    	ResultSet rs = getResultSet.executeQuery("SELECT date,name,amount FROM bazarlist order by date");
	            ...
	            public void actionPerformed(ActionEvent e)
	            {
	            		...
	            		if(val!=null){
	            			try{
		            			...
		            			String update = "update bazarlist set amount="+d+" where date="+date+" and name='"+name+"' and amount = "+amt; 
