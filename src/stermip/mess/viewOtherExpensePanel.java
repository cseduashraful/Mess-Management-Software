...
public class viewOtherExpensePanel extends JPanel {
	Image bgimage = null;
	viewOtherExpensePanel(){
	    ...
	    try {
		    ...
		    setLayout(bdl);
		    JLabel picLabel = imageLabel.getImageLabel("picture//otRecords.png");
		    ...
		    this.add(north, BorderLayout.NORTH);
		    	...
		    	ResultSet rs = getResultSet.executeQuery("SELECT date,costName,amount FROM otherExpense order by date");
		    ...
		    edit.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e)
	            {
	            		...
	            		String val = JOptionPane.showInputDialog("Cost Name:"+name+"\nDate:"+date+"\nPrev. Amount:"+amt+"\nEnter New Amount");
	            		if(val!=null){
	            			try{
		            			double d = Double.parseDouble(val);
		            			String update = "update otherExpense set amount="+d+" where date="+date+" and costName='"+name+"' and amount = "+amt; 
